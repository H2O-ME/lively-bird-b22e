...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/lively-bird-b22e
```

A live public deployment of this template is available at [https://lively-bird-b22e.templates.workers.dev](https://lively-bird-b22e.templates.workers.dev)
